...
namespace COMP003A.Assingment6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // if hte class you are instantiating has a constructor that does not take any parameters
            //then you can simplify the value assingment using the syntax below
            ...
            //if the class you are instantiating has contructors that takes parameters
            //then you can simplify the value assingment by passing those values
            //using the syntax below
            Vehicle vehicle3 = new Truck("GMC", "Sierra 1500 AT4", 6, 5.5);
            vehicle3.GetInfo();

            PrintSeparator("vehicle4");
            //a;ternatively, you may use the syntax below, if for some reason your aguments are not in the specific sequence
